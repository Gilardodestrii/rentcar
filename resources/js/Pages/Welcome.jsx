                ...
                <div className="mx-auto flex min-h-screen max-w-6xl flex-col justify-center px-6 py-16">
                    <div className="max-w-3xl space-y-6">
                        ...
                        <div className="flex flex-wrap gap-3 pt-4">
                            <Link href={route('tenants.create')} className="rounded-xl bg-cyan-500 px-5 py-3 font-semibold text-slate-950 hover:bg-cyan-400">Daftar Tenant</Link>
                            <a href={`https://${baseDomain || 'rentivo.my.id'}`} className="rounded-xl border border-white/20 px-5 py-3 font-semibold text-white hover:bg-white/10">Lihat domain</a>
                        </div>
                    </div>
                </div>
            </div>
